export const actifsLeasingColumns = [
  { key: "materiel", label: "Materiel / Equipement" },
  { key: "montantEuro", label: "Montant (EUR)" },
  { key: "dureeLLD", label: "Duree LLD (mois)" },
];

export const actifsLeasingRows = [
  { id: 1, materiel: "Chariot elevateur electrique", montantEuro: 18500, dureeLLD: 48 },
  { id: 2, materiel: "Vehicule utilitaire Renault Master", montantEuro: 32000, dureeLLD: 36 },
  ...
  { id: 6, materiel: "Vehicule berline Peugeot 308", montantEuro: 28000, dureeLLD: 36 },
  { id: 7, materiel: "Photocopieur couleur", montantEuro: 3600, dureeLLD: 48 },
  { id: 8, materiel: "Pont elevateur atelier", montantEuro: 7200, dureeLLD: 60 },
  ...
  { id: 11, materiel: "Vehicule utilitaire Citroen Berlingo", montantEuro: 24500, dureeLLD: 36 },
  ...
  { id: 14, materiel: "Ecrans moniteurs (lot 15)", montantEuro: 7500, dureeLLD: 36 },
  { id: 15, materiel: "Groupe electrogene", montantEuro: 11000, dureeLLD: 60 },
];
...
export const actifsLeasingStats = [
  ...
  { id: 3, label: "Duree moyenne", value: "46.4 mois", helper: "Duree moyenne des contrats", accent: "amber" },
];
