export const sousTraitanceColumns = [
  { key: "societe", label: "Societe de sous-traitance" },
  { key: "typePrestation", label: "Type de prestation" },
  { key: "montantEuro", label: "Montant facture (EUR)" },
];

export const sousTraitanceRows = [
  { id: 1, societe: "Mecaprecis", typePrestation: "Usinage de precision", montantEuro: 42000 },
  ...
  { id: 5, societe: "Elec Pro", typePrestation: "Cablage electrique", montantEuro: 31500 },
  ...
  { id: 9, societe: "Control Qualite SAS", typePrestation: "Controle non destructif", montantEuro: 14200 },
  ...
  { id: 14, societe: "Secu Expert", typePrestation: "Audit securite", montantEuro: 8500 },
  { id: 15, societe: "Emboutissage Pro", typePrestation: "Emboutissage tole", montantEuro: 35600 },
  { id: 16, societe: "Clean Indus", typePrestation: "Degraissage pieces", montantEuro: 11200 },
  { id: 17, societe: "Elec Pro", typePrestation: "Installation electrique", montantEuro: 45000 },
  { id: 18, societe: "Control Qualite SAS", typePrestation: "Metrologie", montantEuro: 12300 },
];

export const sousTraitanceStats = [
  { id: 1, label: "Prestations", value: "18", helper: "Nombre de lignes facturees", accent: "blue" },
  { id: 2, label: "Montant total", value: "465 300 EUR", helper: "Total facture sous-traitants", accent: "green" },
  { id: 3, label: "Sous-traitants", value: "10", helper: "Societes distinctes", accent: "amber" },
...
export const chartByPrestation = [
  ...
  { label: "Electricite", value: 76500, display: "76 500 EUR", color: "#ef4444" },
  { label: "Controle / Qualite", value: 26500, display: "26 500 EUR", color: "#8b5cf6" },
