    ...
    <div className="home">
      ...
      <section className="home-services">
        <div className="home-services__header">
          <p className="home-label">Fonctionnalites</p>
          <h2>Tout ce dont vous avez besoin</h2>
          <p>De l'import a l'analyse, chaque etape est pensee pour des utilisateurs non techniques.</p>
        </div>
        ...
        <div className="home-services__grid">
          <article className="home-svc">
            ...
            <p>Deposez un fichier Excel exporte depuis Wavesoft. L'outil le lit et extrait les donnees utiles.</p>
          </article>
          ...
          <article className="home-svc">
            ...
            <p>Recherchez, triez et filtrez vos donnees par famille, fournisseur, pays ou unite.</p>
          </article>
          ...
          <article className="home-svc">
            ...
            <p>Consultez la repartition par matiere, fournisseur et zone geographique d'un seul coup d'oeil.</p>
          </article>
          ...
          <article className="home-svc">
            ...
            <h3>Conversions</h3>
            <p>Les unites sont harmonisees automatiquement : pieces, metres, litres vers kilogrammes et tonnes.</p>
          </article>
          ...
          <article className="home-svc">
            ...
            <h3>Multi-donnees</h3>
            <p>Matieres, deplacements, sous-traitance, leasing : chaque categorie a son propre tableau.</p>
          </article>
          ...
          <article className="home-svc">
            ...
            <h3>Bilan carbone</h3>
            <p>Les donnees sont preparees pour etre exploitees avec les facteurs d'emission ADEME.</p>
          </article>
        </div>
      </section>
      ...
      <section className="home-how">
        ...
        <div className="home-how__steps">
          ...
          <div className="home-how__step">
            ...
            <p>Les colonnes sont detectees, les unites converties et les donnees regroupees.</p>
          </div>
          <div className="home-how__step">
            <div className="home-how__num">03</div>
            <h3>Consultez les resultats</h3>
      ...
      <section className="home-cta">
        <div className="home-cta__inner">
          ...
          <p>Importez votre premier fichier et consultez vos donnees en quelques secondes.</p>
          <Link to="/import" className="home-btn home-btn--fill">
