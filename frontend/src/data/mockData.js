...
export const collectRows = [
  { id: 1, reference: "MAT-001", designation: "Bobine acier galva", famille: "Acier", sousFamille: "Galvanisé", fournisseur: "Metal Nord", quantite: 120, unite: "kg", poidsKg: 120, poidsTonne: 0.12, ville: "Lille", pays: "France" },
  { id: 2, reference: "MAT-002", designation: "Profil aluminium T6", famille: "Aluminium", sousFamille: "Extrudé", fournisseur: "Alu Tech", quantite: 85, unite: "kg", poidsKg: 85, poidsTonne: 0.085, ville: "Lyon", pays: "France" },
  { id: 3, reference: "MAT-003", designation: "Granules PP naturel", famille: "Plastique", sousFamille: "Polypropylène", fournisseur: "Polymix", quantite: 320, unite: "kg", poidsKg: 320, poidsTonne: 0.32, ville: "Bruxelles", pays: "Belgique" },
  ...
  { id: 6, reference: "MAT-006", designation: "Tôle inox 304", famille: "Acier", sousFamille: "Inoxydable", fournisseur: "Metal Nord", quantite: 200, unite: "kg", poidsKg: 200, poidsTonne: 0.2, ville: "Lille", pays: "France" },
  ...
  { id: 11, reference: "MAT-011", designation: "Vis CHC M8x30", famille: "Visserie", sousFamille: "Inox", fournisseur: "FixAll", quantite: 5000, unite: "pièces", poidsKg: 25, poidsTonne: 0.025, ville: "Milan", pays: "Italie" },
  { id: 12, reference: "MAT-012", designation: "Joints EPDM", famille: "Caoutchouc", sousFamille: "EPDM", fournisseur: "SealPlus", quantite: 300, unite: "pièces", poidsKg: 6, poidsTonne: 0.006, ville: "Barcelone", pays: "Espagne" },
  { id: 13, reference: "MAT-013", designation: "Roulement 6205", famille: "Mécanique", sousFamille: "Roulement", fournisseur: "BearTech", quantite: 100, unite: "pièces", poidsKg: 12, poidsTonne: 0.012, ville: "Göteborg", pays: "Suède" },
  ...
  { id: 17, reference: "MAT-017", designation: "Câble souple 3G1.5", famille: "Électricité", sousFamille: "Câble", fournisseur: "ElecLine", quantite: 500, unite: "m", poidsKg: 45, poidsTonne: 0.045, ville: "Paris", pays: "France" },
...
export const summaryCards = [
  ...
  { id: 3, label: "Familles", value: "11", helper: "Nombre de familles de matières", accent: "amber" },
  { id: 4, label: "Lignes importées", value: "18", helper: "Nombre de lignes de données", accent: "slate" },
];
